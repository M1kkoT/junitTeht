...
public class ExtraTest extends AbstractParent {
    ...
    public void testNeliojuuriNegat() {
        IllegalArgumentException ex = assertThrows(IllegalArgumentException.class, () -> laskin.neliojuuri(-5),
                "Negatiivisella numerolla jako ei tuottanut poikkeusta");
        assertEquals("Negatiivisella luvulla ei ole neliöjuurta.", ex.getMessage(), "väärä virheilmoitus");
